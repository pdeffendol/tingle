...
class FormBuilderTest extends BaseTest
{
    ...
    public function test_fields_for()
    {
        ...
        $this->assertInstanceOf(get_class($this->builder), $ff, 'Returns builder with same class as caller');
        ...
        $ff = $this->builder->fields_for('hash_field', array('builder' => 'Tingle\Tests\TestBuilder'));
        $this->assertInstanceOf('Tingle\Tests\TestBuilder', $ff, 'Allows specifying builder class');
    }
