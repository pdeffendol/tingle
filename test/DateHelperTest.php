...
require_once dirname(__FILE__).'/../lib/helpers/DateHelper.php';
...
class DateHelperTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$this->assertEquals('Mon, 15 Aug 05 15:52:01 +0000', Tingle_DateHelper::format_date(new DateTime($this->date)));
	}
	
	public function test_date_with_format()
	{
		$this->assertEquals('08/15/2005', Tingle_DateHelper::format_date(new DateTime($this->date), 'm/d/Y'));
	}
	
	public function test_date_string()
	{
		$this->assertEquals('Mon, 15 Aug 05 15:52:01 +0000', Tingle_DateHelper::format_date($this->date));
	}
	
	public function test_datetime_tag_defaults()
	{
		$actual = Tingle_DateHelper::datetime_tag($this->date);
	...
	{
		$actual = Tingle_DateHelper::datetime_tag($this->date, 'm/d/Y');
		$matcher = array('tag' => 'abbr',
		                 'attributes' => array(
			                 'title' => '2005-08-15T15:52:01+0000'),
										 'content' => '08/15/2005');
	...
	{
		$actual = Tingle_DateHelper::datetime_tag($this->date, 'm/d/Y', array('class' => 'date'));
		$matcher = array('tag' => 'abbr',
		                 'attributes' => array(
										   'class' => 'date',
			                 'title' => '2005-08-15T15:52:01+0000'),
	...
	{
		$actual = Tingle_DateHelper::datetime_tag($this->date, 'm/d/Y', array('title' => 'expendable'));
		$matcher = array('tag' => 'abbr',
		                 'attributes' => array(
			                 'title' => '2005-08-15T15:52:01+0000'),
										 'content' => '08/15/2005');
