...
class UrlHelper
{
    ...
    {
        $encode = isset($html_options['encode']) ? $html_options['encode'] : null;
        $url_params = array();
        if (isset($html_options['cc'])) $url_params['cc'] = $cc;
        if (isset($html_options['bcc'])) $url_params['bcc'] = $bcc;
        if (isset($html_options['subject'])) $url_params['subject'] = $subject;
        if (isset($html_options['body'])) $url_params['body'] = $body;
    ...
    private static function options_for_javascript($options)
    {
        ...
        $popup = isset($options['popup']) ? $options['popup'] : null;
